$([IPython.events]).on('app_initialized.NotebookApp', function(){
  // Define and load a nim codemirror mode. Won't be needed once a  codemirror mode for nim is merged into codemirror'
  //Original: https://github.com/zah/nim.lt/blob/master/codemirror/nimrod.js
  ...
  CodeMirror.defineMode("nim", function(conf, parserConf) {
    ...
    var commonBuiltins = ["int", "int8", "int16", "int32", "int64", "uint", "uint8", "uint16",
                          ...
                          "TFileHandle", "isMainModule", "CompileDate", "CompileTime", "NimVersion",
