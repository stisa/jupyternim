...
const initFlags = [ "--hotcodereloading:on",#"--nimcache:" & (jnTempDir).escape,
                    "-d:jupyter", # ORDER IS IMPORTANT 
                    "-d:release",
                    "--verbosity:0",
                    "-o:" & jnTempDir / outCodeServerName]

const initCodecells = [ "discard \"generated by jupyternim\"\n"]


var flags: seq[string] = @initFlags

when not defined(release):
  flags[^2] = "-d:debug" #switch release to debug
